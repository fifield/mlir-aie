...
module {
  aie.device(NPUDEVICE) {
    ...
    aiex.runtime_sequence(%out0 : memref<18xi32>, %out1 : memref<18xi32>, %out2 : memref<18xi32>) {
      ...
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 3 : i32, column = 0 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 4 : i32, column = 0 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 2 : i32, column = 1 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 3 : i32, column = 1 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 4 : i32, column = 1 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 2 : i32, column = 2 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 3 : i32, column = 2 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
      aiex.npu.maskwrite32 {address = 0x32038 : ui32, row = 4 : i32, column = 2 : i32, value = 0x1 : ui32, mask = 0x1 : ui32}
