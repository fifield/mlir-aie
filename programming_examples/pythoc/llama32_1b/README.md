...
| BF16 GEMM (prefill matmuls) | rms_gemms_rope, o_ffn | ☐ next — see *Prefill GEMM plan* | — |
...
| `rms_gemms_rope` | prefill (RMSNorm + QKV GEMM + RoPE) | per-layer prefill | ☐ cached MLIR substrate |
