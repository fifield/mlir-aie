...
def compile_matvec_rms(output_dir: Optional[str] = None, verbose: bool = False) -> Path:
    ...
    with tempfile.TemporaryDirectory(prefix="matvec_rms_pythoc_") as tmp:
        produced = compile_pythoc_source(
...
def compile_awq_mv(output_dir: Optional[str] = None, verbose: bool = False) -> Path:
    ...
    extras = {
        ...
        "v32accfloat_to_v32bf16": v32accfloat_to_v32bf16,
        "v32bf16_to_v32accfloat": v32bf16_to_v32accfloat,
        "acc32_v32_I256_ups": acc32_v32_I256_ups,
        "ACC2048_add_conf": ACC2048_add_conf,
        "ACC2048_accfloat_sub_conf": ACC2048_accfloat_sub_conf,
        "reduce_add_reassoc": reduce_add_reassoc,
        "unpack_I1024_I8_I4": unpack_I1024_I8_I4,
        "vector_mul": vector_mul,
        "vector_cast": vector_cast,
        "vector_extract": vector_extract,
        "broadcast": broadcast,
