module {
  aie.device(npu2) @awq_gemv_seg {
    ...
    %buf3 = aie.buffer(%tile_0_2) {sym_name = "buf3"} : memref<8192xbf16, 2 : i32> 
    ...
    %buf0 = aie.buffer(%tile_0_2) {sym_name = "buf0"} : memref<8xbf16, 2 : i32> 
    ...
    %__air_external_buffer_3 = aie.external_buffer {sym_name = "__air_external_buffer_3"} : memref<8xbf16>
    %mem_0_2 = aie.mem(%tile_0_2) {
      %0 = aie.dma_start(MM2S, 0, ^bb1, ^bb3)
    ^bb1:  // 2 preds: ^bb0, ^bb1
      aie.use_lock(%lock_0_2_6, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf0 : memref<8xbf16, 2 : i32>, 0, 8) {task_id = 0 : i32}
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb6
      ...
      aie.dma_bd(%buf3 : memref<8192xbf16, 2 : i32>, 0, 8192) {task_id = 0 : i32}
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      func.call @awq_gemv_u4_bf16(%buf3, %buf2, %buf1, %buf0) : (memref<8192xbf16, 2 : i32>, memref<32768xui8, 2 : i32>, memref<1024xbf16, 2 : i32>, memref<8xbf16, 2 : i32>) -> ()
      aie.use_lock(%lock_0_2_3, Release, 1)
      aie.use_lock(%lock_0_2_1, Release, 1)
      aie.use_lock(%lock_0_2, Release, 1)
      aie.use_lock(%lock_0_2_6, Release, 1)
      cf.br ^bb1
    } {air.herd_local_id = array<i64: 0, 0>, air.herd_name = "awq_gemv_herd", air.herd_size = array<i64: 1, 1>, link_with = "awq_gemv_k8192_m8_g128_vecdeq_pythoc.o"}
    func.func private @awq_gemv_u4_bf16(memref<8192xbf16, 2 : i32>, memref<32768xui8, 2 : i32>, memref<1024xbf16, 2 : i32>, memref<8xbf16, 2 : i32>) attributes {link_with = "awq_gemv_k8192_m8_g128_vecdeq_pythoc.o", llvm.emit_c_interface}
    aie.packet_flow(0) {
    ...
    aie.runtime_sequence @awq_gemv_seg_sequence(%arg0: memref<8192xbf16>, %arg1: memref<32768xui8>, %arg2: memref<1024xbf16>, %arg3: memref<8xbf16>) {
      %0 = aiex.dma_configure_task_for @air_channel_0 {
        aie.dma_bd(%arg0 : memref<8192xbf16>, 0, 8192, [<size = 16, stride = 512>, <size = 512, stride = 1>]) {packet = #aie.packet_info<pkt_type = 0, pkt_id = 0>}
        aie.end
      }
      ...
      %3 = aiex.dma_configure_task_for @air_channel_3 {
        aie.dma_bd(%arg3 : memref<8xbf16>, 0, 8, [<size = 8, stride = 1>])
        aie.end
      } {issue_token = true}
  ...
  aie.device(npu2) {
    aie.runtime_sequence @awq_gemv(%arg0: memref<8192xbf16>, %arg1: memref<32768xui8>, %arg2: memref<1024xbf16>, %arg3: memref<8xbf16>) {
      aiex.configure @awq_gemv_seg {
        aiex.run @awq_gemv_seg_sequence(%arg0, %arg1, %arg2, %arg3) : (memref<8192xbf16>, memref<32768xui8>, memref<1024xbf16>, memref<8xbf16>)
      }
    }
  }
}
