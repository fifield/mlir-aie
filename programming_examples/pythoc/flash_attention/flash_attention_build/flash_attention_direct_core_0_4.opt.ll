; ModuleID = '/work/npu-dev/mlir-aie/programming_examples/pythoc/flash_attention/flash_attention_build/flash_attention_direct_core_0_4.peanohack.ll'
...
3:                                                ; preds = %3, %1
  ...
  tail call void @zero_fill_g_bf16(ptr nonnull @g_stage2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @q_stage2, ptr nonnull @k_stage2, ptr nonnull @g_stage2)
