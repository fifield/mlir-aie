; ModuleID = '/work/npu-dev/mlir-aie/programming_examples/pythoc/flash_attention/flash_attention_build/flash_attention_direct_core_2_4.peanohack.ll'
...
1:                                                ; preds = %0, %46
  %2 = phi i64 [ 0, %0 ], [ %47, %46 ]
  tail call void @zero_fill_gp_bf16(ptr nonnull @softmax_gp_stage2)
  tail call void @zero_fill_sp_bf16(ptr nonnull @softmax_sp_stage2)
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @softmax_up_stage2)
  br label %3
...
3:                                                ; preds = %3, %1
  ...
  tail call void @max_g_bf16(ptr nonnull @softmax_g_stage2, ptr nonnull @softmax_u_stage2)
  tail call void @maximum_up_u_bf16(ptr nonnull @softmax_up_stage2, ptr nonnull @softmax_u_stage2)
  tail call void @exp_g_minus_u(ptr nonnull @softmax_u_stage2, ptr nonnull @softmax_g_stage2)
  tail call void @exp_up_minus_u(ptr nonnull @softmax_up_stage2, ptr nonnull @softmax_u_stage2, ptr nonnull @softmax_r_stage2)
  tail call void @mul_r_gp(ptr nonnull @softmax_r_stage2, ptr nonnull @softmax_gp_stage2)
  tail call void @vector_copy_32x96elems(i32 0, ptr nonnull @softmax_g_stage2, ptr nonnull @softmax_g_copy_stage2)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @vector_accum_32x64elems(ptr nonnull @softmax_gv_stage2, ptr nonnull @softmax_gp_stage2)
  tail call void @llvm.aie2p.release(i32 53, i32 1)
  tail call void @sum_g(ptr nonnull @softmax_g_stage2, ptr nonnull @softmax_s_stage2)
  tail call void @accum_sp_r_s(ptr nonnull @softmax_sp_stage2, ptr nonnull @softmax_r_stage2, ptr nonnull @softmax_s_stage2)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @softmax_s_stage2, ptr nonnull @softmax_sp_stage2)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @softmax_u_stage2, ptr nonnull @softmax_up_stage2)
...
.preheader11:                                     ; preds = %3, %.preheader11
  ...
  %11 = getelementptr bfloat, ptr @cascade_gp_stage2, i20 %10
...
.preheader10:                                     ; preds = %.preheader11, %.preheader10
  ...
  %17 = getelementptr bfloat, ptr @cascade_up_stage2, i20 %16
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %23 = getelementptr bfloat, ptr @cascade_sp_stage2, i20 %22
...
26:                                               ; preds = %.preheader9
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @softmax_up_stage2, ptr nonnull @prev_up_stage2)
  tail call void @maximum_up_u_bf16(ptr nonnull @cascade_up_stage2, ptr nonnull @softmax_up_stage2)
  tail call void @exp_up_minus_u(ptr nonnull @cascade_up_stage2, ptr nonnull @softmax_up_stage2, ptr nonnull @r_from_cascade_stage2)
  tail call void @exp_up_minus_u(ptr nonnull @prev_up_stage2, ptr nonnull @softmax_up_stage2, ptr nonnull @r_from_local_stage2)
  tail call void @mul_r_gp(ptr nonnull @r_from_cascade_stage2, ptr nonnull @cascade_gp_stage2)
  tail call void @mul_r_gp(ptr nonnull @r_from_local_stage2, ptr nonnull @softmax_gp_stage2)
  tail call void @add_gp_g(ptr nonnull @softmax_gp_stage2, ptr nonnull @cascade_gp_stage2)
  tail call void @zero_fill_sp_bf16(ptr nonnull @tmp_sp_stage2)
  tail call void @accum_sp_r_s(ptr nonnull @cascade_sp_stage2, ptr nonnull @r_from_cascade_stage2, ptr nonnull @tmp_sp_stage2)
  tail call void @accum_sp_r_s(ptr nonnull @softmax_sp_stage2, ptr nonnull @r_from_local_stage2, ptr nonnull @tmp_sp_stage2)
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @tmp_sp_stage2, ptr nonnull @cascade_sp_stage2)
  br label %27

27:                                               ; preds = %26, %27
  %28 = phi i64 [ 0, %26 ], [ %32, %27 ]
  %29 = trunc nuw i64 %28 to i20
  %30 = getelementptr bfloat, ptr @cascade_gp_stage2, i20 %29
...
.preheader8:                                      ; preds = %27, %.preheader8
  ...
  %36 = getelementptr bfloat, ptr @softmax_up_stage2, i20 %35
...
.preheader:                                       ; preds = %.preheader8, %.preheader
  ...
  %42 = getelementptr bfloat, ptr @cascade_sp_stage2, i20 %41
