...
4:                                                ; preds = %1
  call void @zero_fill_gp_bf16(ptr @softmax_gp_stage1)
  call void @zero_fill_sp_bf16(ptr @softmax_sp_stage1)
  call void @neg_inf_fill_up_bf16(ptr @softmax_up_stage1)
  br label %5
...
8:                                                ; preds = %5
  ...
  call void @max_g_bf16(ptr @softmax_g_stage1, ptr @softmax_u_stage1)
  call void @maximum_up_u_bf16(ptr @softmax_up_stage1, ptr @softmax_u_stage1)
  call void @exp_g_minus_u(ptr @softmax_u_stage1, ptr @softmax_g_stage1)
  call void @exp_up_minus_u(ptr @softmax_up_stage1, ptr @softmax_u_stage1, ptr @softmax_r_stage1)
  call void @mul_r_gp(ptr @softmax_r_stage1, ptr @softmax_gp_stage1)
  call void @vector_copy_32x96elems(i32 0, ptr @softmax_g_stage1, ptr @softmax_g_copy_stage1)
  call void @llvm.aie2p.release(i32 48, i32 1)
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  call void @vector_accum_32x64elems(ptr @softmax_gv_stage1, ptr @softmax_gp_stage1)
  call void @llvm.aie2p.release(i32 53, i32 1)
  call void @sum_g(ptr @softmax_g_stage1, ptr @softmax_s_stage1)
  call void @accum_sp_r_s(ptr @softmax_sp_stage1, ptr @softmax_r_stage1, ptr @softmax_s_stage1)
  call void @vector_copy_32elems(i32 0, ptr @softmax_s_stage1, ptr @softmax_sp_stage1)
  call void @vector_copy_32elems(i32 0, ptr @softmax_u_stage1, ptr @softmax_up_stage1)
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr bfloat, ptr @cascade_gp_stage1, i64 %11
...
21:                                               ; preds = %18
  ...
  %24 = getelementptr bfloat, ptr @cascade_up_stage1, i64 %19
...
29:                                               ; preds = %26
  ...
  %32 = getelementptr bfloat, ptr @cascade_sp_stage1, i64 %27
  store <32 x bfloat> %31, ptr %32, align 2
  %33 = add i64 %27, 32
  br label %26

34:                                               ; preds = %26
  call void @vector_copy_32elems(i32 0, ptr @softmax_up_stage1, ptr @prev_up_stage1)
  call void @maximum_up_u_bf16(ptr @cascade_up_stage1, ptr @softmax_up_stage1)
  call void @exp_up_minus_u(ptr @cascade_up_stage1, ptr @softmax_up_stage1, ptr @r_from_cascade_stage1)
  call void @exp_up_minus_u(ptr @prev_up_stage1, ptr @softmax_up_stage1, ptr @r_from_local_stage1)
  call void @mul_r_gp(ptr @r_from_cascade_stage1, ptr @cascade_gp_stage1)
  call void @mul_r_gp(ptr @r_from_local_stage1, ptr @softmax_gp_stage1)
  call void @add_gp_g(ptr @softmax_gp_stage1, ptr @cascade_gp_stage1)
  call void @zero_fill_sp_bf16(ptr @tmp_sp_stage1)
  call void @accum_sp_r_s(ptr @cascade_sp_stage1, ptr @r_from_cascade_stage1, ptr @tmp_sp_stage1)
  call void @accum_sp_r_s(ptr @softmax_sp_stage1, ptr @r_from_local_stage1, ptr @tmp_sp_stage1)
  call void @vector_copy_32elems(i32 0, ptr @tmp_sp_stage1, ptr @cascade_sp_stage1)
  br label %35
...
38:                                               ; preds = %35
  %39 = getelementptr bfloat, ptr @cascade_gp_stage1, i64 %36
...
46:                                               ; preds = %43
  %47 = getelementptr bfloat, ptr @softmax_up_stage1, i64 %44
...
54:                                               ; preds = %51
  %55 = getelementptr bfloat, ptr @cascade_sp_stage1, i64 %52
