; ModuleID = '/work/npu-dev/mlir-aie/programming_examples/pythoc/flash_attention/flash_attention_build/flash_attention_direct_core_1_4.peanohack.ll'
...
2:                                                ; preds = %2, %.preheader
  ...
  tail call void @zero_fill_gp_bf16(ptr nonnull @gp_in_stage2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_g_b_bf16(ptr nonnull @g_in_stage2, ptr nonnull @v_stage2, ptr nonnull @gp_in_stage2)
