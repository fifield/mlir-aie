...
.preheader6.preheader:                            ; preds = %0, %20
  ...
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @up_seg1_s0_q1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @copy_tile(ptr nonnull @qk_seg1_s0_q1, ptr nonnull @q_seg1_s0_q1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  ...
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @s_seg1_s0_q1, ptr nonnull @sp_seg1_s0_q1)
...
20:                                               ; preds = %.preheader
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @up_seg1_s0_q1, ptr nonnull @prev_up_seg1_q1)
  ...
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @tmp_sp_seg1_q1, ptr nonnull @merged_sp_seg1_q1)
