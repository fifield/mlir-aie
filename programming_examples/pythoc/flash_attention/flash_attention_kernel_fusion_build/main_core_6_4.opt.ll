; ModuleID = '/work/npu-dev/mlir-aie/programming_examples/pythoc/flash_attention/flash_attention_kernel_fusion_build/main_core_6_4.peanohack.ll'
...
.preheader11.preheader:                           ; preds = %0, %40
  %1 = phi i64 [ 0, %0 ], [ %41, %40 ]
  tail call void @zero_fill_gp_bf16_pythoc(ptr nonnull @gp_seg1_s2_q2)
  tail call void @zero_fill_sp_bf16_pythoc(ptr nonnull @sp_seg1_s2_q2)
  tail call void @neg_inf_fill_up_bf16_pythoc(ptr nonnull @up_seg1_s2_q2)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile_pythoc(ptr nonnull @qk_seg1_s2_q2, ptr nonnull @q_seg1_s2_q2)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16_pythoc(ptr nonnull @g_seg1_s2_q2)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @q_seg1_s2_q2, ptr nonnull @qk_seg1_s2_q2, ptr nonnull @g_seg1_s2_q2)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @fused_softmax(ptr nonnull @g_seg1_s2_q2, ptr nonnull @up_seg1_s2_q2, ptr nonnull @s_seg1_s2_q2, ptr nonnull @r_seg1_s2_q2)
  tail call void @mul_r_gp(ptr nonnull @r_seg1_s2_q2, ptr nonnull @gp_seg1_s2_q2)
  tail call void @matmul_g_b_bf16(ptr nonnull @g_seg1_s2_q2, ptr nonnull @v_seg1_s2_q2, ptr nonnull @gp_seg1_s2_q2)
  tail call void @accum_sp_r_s(ptr nonnull @sp_seg1_s2_q2, ptr nonnull @r_seg1_s2_q2, ptr nonnull @s_seg1_s2_q2)
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @s_seg1_s2_q2, ptr nonnull @sp_seg1_s2_q2)
...
.preheader11:                                     ; preds = %.preheader11.preheader, %.preheader11
  ...
  %5 = getelementptr bfloat, ptr @merged_gp_seg1_s2_q2, i20 %4
...
.preheader10:                                     ; preds = %.preheader11, %.preheader10
  ...
  %11 = getelementptr bfloat, ptr @merged_up_seg1_s2_q2, i20 %10
...
.preheader9:                                      ; preds = %.preheader10, %.preheader9
  ...
  %17 = getelementptr bfloat, ptr @merged_sp_seg1_s2_q2, i20 %16
...
20:                                               ; preds = %.preheader9
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @up_seg1_s2_q2, ptr nonnull @prev_up_seg1_s2_q2)
  tail call void @maximum_up_u_bf16(ptr nonnull @merged_up_seg1_s2_q2, ptr nonnull @up_seg1_s2_q2)
  tail call void @exp_up_minus_u(ptr nonnull @merged_up_seg1_s2_q2, ptr nonnull @up_seg1_s2_q2, ptr nonnull @r_cascade_seg1_s2_q2)
  tail call void @exp_up_minus_u(ptr nonnull @prev_up_seg1_s2_q2, ptr nonnull @up_seg1_s2_q2, ptr nonnull @r_local_seg1_s2_q2)
  tail call void @mul_r_gp(ptr nonnull @r_cascade_seg1_s2_q2, ptr nonnull @merged_gp_seg1_s2_q2)
  tail call void @mul_r_gp(ptr nonnull @r_local_seg1_s2_q2, ptr nonnull @gp_seg1_s2_q2)
  tail call void @add_gp_g(ptr nonnull @gp_seg1_s2_q2, ptr nonnull @merged_gp_seg1_s2_q2)
  tail call void @zero_fill_sp_bf16_pythoc(ptr nonnull @tmp_sp_seg1_s2_q2)
  tail call void @accum_sp_r_s(ptr nonnull @merged_sp_seg1_s2_q2, ptr nonnull @r_cascade_seg1_s2_q2, ptr nonnull @tmp_sp_seg1_s2_q2)
  tail call void @accum_sp_r_s(ptr nonnull @sp_seg1_s2_q2, ptr nonnull @r_local_seg1_s2_q2, ptr nonnull @tmp_sp_seg1_s2_q2)
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @tmp_sp_seg1_s2_q2, ptr nonnull @merged_sp_seg1_s2_q2)
  br label %21

21:                                               ; preds = %20, %21
  %22 = phi i64 [ 0, %20 ], [ %26, %21 ]
  %23 = trunc nuw i64 %22 to i20
  %24 = getelementptr bfloat, ptr @merged_gp_seg1_s2_q2, i20 %23
...
.preheader8:                                      ; preds = %21, %.preheader8
  ...
  %30 = getelementptr bfloat, ptr @up_seg1_s2_q2, i20 %29
...
.preheader:                                       ; preds = %.preheader8, %.preheader
  ...
  %36 = getelementptr bfloat, ptr @merged_sp_seg1_s2_q2, i20 %35
