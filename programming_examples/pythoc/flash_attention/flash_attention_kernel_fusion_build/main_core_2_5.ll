...
4:                                                ; preds = %1
  call void @zero_fill_gp_bf16_pythoc(ptr @gp_seg0_s3_q2)
  call void @zero_fill_sp_bf16_pythoc(ptr @sp_seg0_s3_q2)
  call void @neg_inf_fill_up_bf16_pythoc(ptr @up_seg0_s3_q2)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @llvm.aie2p.release(i32 49, i32 1)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @llvm.aie2p.release(i32 49, i32 1)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @copy_tile_pythoc(ptr @qk_seg0_s3_q2, ptr @q_seg0_s3_q2)
  call void @llvm.aie2p.release(i32 49, i32 1)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @llvm.aie2p.release(i32 49, i32 1)
  br label %5
...
8:                                                ; preds = %5
  call void @zero_fill_g_bf16_pythoc(ptr @g_seg0_s3_q2)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @matmul_a_b_bf16(ptr @q_seg0_s3_q2, ptr @qk_seg0_s3_q2, ptr @g_seg0_s3_q2)
  call void @llvm.aie2p.release(i32 49, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @fused_softmax(ptr @g_seg0_s3_q2, ptr @up_seg0_s3_q2, ptr @s_seg0_s3_q2, ptr @r_seg0_s3_q2)
  call void @mul_r_gp(ptr @r_seg0_s3_q2, ptr @gp_seg0_s3_q2)
  call void @matmul_g_b_bf16(ptr @g_seg0_s3_q2, ptr @v_seg0_s3_q2, ptr @gp_seg0_s3_q2)
  call void @accum_sp_r_s(ptr @sp_seg0_s3_q2, ptr @r_seg0_s3_q2, ptr @s_seg0_s3_q2)
  call void @vector_copy_32elems_pythoc(i32 0, ptr @s_seg0_s3_q2, ptr @sp_seg0_s3_q2)
...
13:                                               ; preds = %10
  %14 = getelementptr bfloat, ptr @gp_seg0_s3_q2, i64 %11
...
21:                                               ; preds = %18
  %22 = getelementptr bfloat, ptr @up_seg0_s3_q2, i64 %19
...
29:                                               ; preds = %26
  %30 = getelementptr bfloat, ptr @sp_seg0_s3_q2, i64 %27
