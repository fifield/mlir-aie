...
8:                                                ; preds = %5
  call void @zero_fill_g_bf16_pythoc(ptr @g_seg0_s0_q3)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @matmul_a_b_bf16(ptr @q_seg0_s0_q3, ptr @qk_seg0_s0_q3, ptr @g_seg0_s0_q3)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  call void @fused_softmax(ptr @g_seg0_s0_q3, ptr @up_seg0_s0_q3, ptr @s_seg0_s0_q3, ptr @r_seg0_s0_q3)
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr bfloat, ptr @merged_gp_seg0_q3, i64 %11
...
21:                                               ; preds = %18
  ...
  %24 = getelementptr bfloat, ptr @merged_up_seg0_q3, i64 %19
...
29:                                               ; preds = %26
  ...
  %32 = getelementptr bfloat, ptr @merged_sp_seg0_q3, i64 %27
...
34:                                               ; preds = %26
  ...
  call void @mul_r_gp(ptr @r_cascade_seg0_q3, ptr @merged_gp_seg0_q3)
  call void @mul_r_gp(ptr @r_local_seg0_q3, ptr @gp_seg0_s0_q3)
  call void @add_gp_g(ptr @gp_seg0_s0_q3, ptr @merged_gp_seg0_q3)
