; ModuleID = '/work/npu-dev/mlir-aie/programming_examples/pythoc/flash_attention/flash_attention_kernel_fusion_build/main_core_1_2.peanohack.ll'
...
.preheader6.preheader:                            ; preds = %0, %20
  ...
  tail call void @zero_fill_gp_bf16_pythoc(ptr nonnull @gp_seg0_s0_q1)
  tail call void @zero_fill_sp_bf16_pythoc(ptr nonnull @sp_seg0_s0_q1)
  tail call void @neg_inf_fill_up_bf16_pythoc(ptr nonnull @up_seg0_s0_q1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @copy_tile_pythoc(ptr nonnull @qk_seg0_s0_q1, ptr nonnull @q_seg0_s0_q1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @zero_fill_g_bf16_pythoc(ptr nonnull @g_seg0_s0_q1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @q_seg0_s0_q1, ptr nonnull @qk_seg0_s0_q1, ptr nonnull @g_seg0_s0_q1)
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  tail call void @fused_softmax(ptr nonnull @g_seg0_s0_q1, ptr nonnull @up_seg0_s0_q1, ptr nonnull @s_seg0_s0_q1, ptr nonnull @r_seg0_s0_q1)
  tail call void @mul_r_gp(ptr nonnull @r_seg0_s0_q1, ptr nonnull @gp_seg0_s0_q1)
  tail call void @matmul_g_b_bf16(ptr nonnull @g_seg0_s0_q1, ptr nonnull @v_seg0_s0_q1, ptr nonnull @gp_seg0_s0_q1)
  tail call void @accum_sp_r_s(ptr nonnull @sp_seg0_s0_q1, ptr nonnull @r_seg0_s0_q1, ptr nonnull @s_seg0_s0_q1)
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @s_seg0_s0_q1, ptr nonnull @sp_seg0_s0_q1)
...
.preheader6:                                      ; preds = %.preheader6.preheader, %.preheader6
  ...
  %5 = getelementptr bfloat, ptr @merged_gp_seg0_q1, i20 %4
...
.preheader5:                                      ; preds = %.preheader6, %.preheader5
  ...
  %11 = getelementptr bfloat, ptr @merged_up_seg0_q1, i20 %10
...
.preheader:                                       ; preds = %.preheader5, %.preheader
  ...
  %17 = getelementptr bfloat, ptr @merged_sp_seg0_q1, i20 %16
...
20:                                               ; preds = %.preheader
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @up_seg0_s0_q1, ptr nonnull @prev_up_seg0_q1)
  tail call void @maximum_up_u_bf16(ptr nonnull @merged_up_seg0_q1, ptr nonnull @up_seg0_s0_q1)
  tail call void @exp_up_minus_u(ptr nonnull @merged_up_seg0_q1, ptr nonnull @up_seg0_s0_q1, ptr nonnull @r_cascade_seg0_q1)
  tail call void @exp_up_minus_u(ptr nonnull @prev_up_seg0_q1, ptr nonnull @up_seg0_s0_q1, ptr nonnull @r_local_seg0_q1)
  tail call void @mul_r_gp(ptr nonnull @r_cascade_seg0_q1, ptr nonnull @merged_gp_seg0_q1)
  tail call void @mul_r_gp(ptr nonnull @r_local_seg0_q1, ptr nonnull @gp_seg0_s0_q1)
  tail call void @add_gp_g(ptr nonnull @gp_seg0_s0_q1, ptr nonnull @merged_gp_seg0_q1)
  tail call void @zero_fill_sp_bf16_pythoc(ptr nonnull @tmp_sp_seg0_q1)
  tail call void @accum_sp_r_s(ptr nonnull @merged_sp_seg0_q1, ptr nonnull @r_cascade_seg0_q1, ptr nonnull @tmp_sp_seg0_q1)
  tail call void @accum_sp_r_s(ptr nonnull @sp_seg0_s0_q1, ptr nonnull @r_local_seg0_q1, ptr nonnull @tmp_sp_seg0_q1)
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @tmp_sp_seg0_q1, ptr nonnull @merged_sp_seg0_q1)
  tail call void @div_gp_sp(ptr nonnull @merged_sp_seg0_q1, ptr nonnull @merged_gp_seg0_q1)
