...
8:                                                ; preds = %5
  call void @zero_fill_g_bf16_pythoc(ptr @g_seg1_s2_q2)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @matmul_a_b_bf16(ptr @q_seg1_s2_q2, ptr @qk_seg1_s2_q2, ptr @g_seg1_s2_q2)
  call void @llvm.aie2p.release(i32 49, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @fused_softmax(ptr @g_seg1_s2_q2, ptr @up_seg1_s2_q2, ptr @s_seg1_s2_q2, ptr @r_seg1_s2_q2)
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr bfloat, ptr @merged_gp_seg1_s2_q2, i64 %11
...
21:                                               ; preds = %18
  ...
  %24 = getelementptr bfloat, ptr @merged_up_seg1_s2_q2, i64 %19
...
29:                                               ; preds = %26
  ...
  %32 = getelementptr bfloat, ptr @merged_sp_seg1_s2_q2, i64 %27
...
34:                                               ; preds = %26
  ...
  call void @mul_r_gp(ptr @r_cascade_seg1_s2_q2, ptr @merged_gp_seg1_s2_q2)
  call void @mul_r_gp(ptr @r_local_seg1_s2_q2, ptr @gp_seg1_s2_q2)
  call void @add_gp_g(ptr @gp_seg1_s2_q2, ptr @merged_gp_seg1_s2_q2)
...
38:                                               ; preds = %35
  %39 = getelementptr bfloat, ptr @merged_gp_seg1_s2_q2, i64 %36
...
46:                                               ; preds = %43
  %47 = getelementptr bfloat, ptr @up_seg1_s2_q2, i64 %44
...
54:                                               ; preds = %51
  %55 = getelementptr bfloat, ptr @merged_sp_seg1_s2_q2, i64 %52
