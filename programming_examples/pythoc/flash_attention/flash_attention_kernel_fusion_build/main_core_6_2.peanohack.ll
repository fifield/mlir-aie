...
4:                                                ; preds = %1
  ...
  call void @zero_fill_gp_bf16_pythoc(ptr @gp_seg1_s0_q2)
  call void @zero_fill_sp_bf16_pythoc(ptr @sp_seg1_s0_q2)
  call void @neg_inf_fill_up_bf16_pythoc(ptr @up_seg1_s0_q2)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @copy_tile_pythoc(ptr @qk_seg1_s0_q2, ptr @q_seg1_s0_q2)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  br label %5
...
8:                                                ; preds = %5
  call void @zero_fill_g_bf16_pythoc(ptr @g_seg1_s0_q2)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @matmul_a_b_bf16(ptr @q_seg1_s0_q2, ptr @qk_seg1_s0_q2, ptr @g_seg1_s0_q2)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 52, i32 -1)
  call void @fused_softmax(ptr @g_seg1_s0_q2, ptr @up_seg1_s0_q2, ptr @s_seg1_s0_q2, ptr @r_seg1_s0_q2)
  call void @mul_r_gp(ptr @r_seg1_s0_q2, ptr @gp_seg1_s0_q2)
  call void @matmul_g_b_bf16(ptr @g_seg1_s0_q2, ptr @v_seg1_s0_q2, ptr @gp_seg1_s0_q2)
  call void @accum_sp_r_s(ptr @sp_seg1_s0_q2, ptr @r_seg1_s0_q2, ptr @s_seg1_s0_q2)
  call void @vector_copy_32elems_pythoc(i32 0, ptr @s_seg1_s0_q2, ptr @sp_seg1_s0_q2)
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr bfloat, ptr @merged_gp_seg1_q2, i64 %11
...
21:                                               ; preds = %18
  ...
  %24 = getelementptr bfloat, ptr @merged_up_seg1_q2, i64 %19
...
29:                                               ; preds = %26
  ...
  %32 = getelementptr bfloat, ptr @merged_sp_seg1_q2, i64 %27
  store <32 x bfloat> %31, ptr %32
  %33 = add i64 %27, 32
  br label %26

34:                                               ; preds = %26
  call void @vector_copy_32elems_pythoc(i32 0, ptr @up_seg1_s0_q2, ptr @prev_up_seg1_q2)
  call void @maximum_up_u_bf16(ptr @merged_up_seg1_q2, ptr @up_seg1_s0_q2)
  call void @exp_up_minus_u(ptr @merged_up_seg1_q2, ptr @up_seg1_s0_q2, ptr @r_cascade_seg1_q2)
  call void @exp_up_minus_u(ptr @prev_up_seg1_q2, ptr @up_seg1_s0_q2, ptr @r_local_seg1_q2)
  call void @mul_r_gp(ptr @r_cascade_seg1_q2, ptr @merged_gp_seg1_q2)
  call void @mul_r_gp(ptr @r_local_seg1_q2, ptr @gp_seg1_s0_q2)
  call void @add_gp_g(ptr @gp_seg1_s0_q2, ptr @merged_gp_seg1_q2)
  call void @zero_fill_sp_bf16_pythoc(ptr @tmp_sp_seg1_q2)
  call void @accum_sp_r_s(ptr @merged_sp_seg1_q2, ptr @r_cascade_seg1_q2, ptr @tmp_sp_seg1_q2)
  call void @accum_sp_r_s(ptr @sp_seg1_s0_q2, ptr @r_local_seg1_q2, ptr @tmp_sp_seg1_q2)
  call void @vector_copy_32elems_pythoc(i32 0, ptr @tmp_sp_seg1_q2, ptr @merged_sp_seg1_q2)
  call void @div_gp_sp(ptr @merged_sp_seg1_q2, ptr @merged_gp_seg1_q2)
