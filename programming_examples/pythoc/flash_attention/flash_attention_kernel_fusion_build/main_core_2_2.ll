...
4:                                                ; preds = %1
  ...
  call void @neg_inf_fill_up_bf16(ptr @up_seg0_s0_q2)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @copy_tile(ptr @qk_seg0_s0_q2, ptr @q_seg0_s0_q2)
  call void @llvm.aie2p.release(i32 51, i32 1)
  call void @llvm.aie2p.acquire(i32 50, i32 -1)
  call void @llvm.aie2p.release(i32 51, i32 1)
  br label %5
...
8:                                                ; preds = %5
  ...
  call void @vector_copy_32elems(i32 0, ptr @s_seg0_s0_q2, ptr @sp_seg0_s0_q2)
...
34:                                               ; preds = %26
  call void @vector_copy_32elems(i32 0, ptr @up_seg0_s0_q2, ptr @prev_up_seg0_q2)
  ...
  call void @vector_copy_32elems(i32 0, ptr @tmp_sp_seg0_q2, ptr @merged_sp_seg0_q2)
