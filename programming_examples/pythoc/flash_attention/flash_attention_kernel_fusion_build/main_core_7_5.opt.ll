...
.preheader6.preheader:                            ; preds = %0, %20
  ...
  tail call void @neg_inf_fill_up_bf16(ptr nonnull @up_seg1_s3_q3)
  ...
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile(ptr nonnull @qk_seg1_s3_q3, ptr nonnull @q_seg1_s3_q3)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  ...
  tail call void @vector_copy_32elems(i32 0, ptr nonnull @s_seg1_s3_q3, ptr nonnull @sp_seg1_s3_q3)
