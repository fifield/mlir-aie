...
4:                                                ; preds = %1
  ...
  call void @neg_inf_fill_up_bf16(ptr @up_seg0_s3_q0)
  call void @llvm.aie2p.acquire(i32 48, i32 -1)
  call void @copy_tile(ptr @qk_seg0_s3_q0, ptr @q_seg0_s3_q0)
...
8:                                                ; preds = %5
  ...
  call void @vector_copy_32elems(i32 0, ptr @s_seg0_s3_q0, ptr @sp_seg0_s3_q0)
