; ModuleID = '/work/npu-dev/mlir-aie/programming_examples/pythoc/flash_attention/flash_attention_kernel_fusion_build/main_core_3_5.peanohack.ll'
...
.preheader6.preheader:                            ; preds = %0, %20
  %1 = phi i64 [ 0, %0 ], [ %21, %20 ]
  tail call void @zero_fill_gp_bf16_pythoc(ptr nonnull @gp_seg0_s3_q3)
  tail call void @zero_fill_sp_bf16_pythoc(ptr nonnull @sp_seg0_s3_q3)
  tail call void @neg_inf_fill_up_bf16_pythoc(ptr nonnull @up_seg0_s3_q3)
  ...
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @copy_tile_pythoc(ptr nonnull @qk_seg0_s3_q3, ptr nonnull @q_seg0_s3_q3)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @zero_fill_g_bf16_pythoc(ptr nonnull @g_seg0_s3_q3)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @matmul_a_b_bf16(ptr nonnull @q_seg0_s3_q3, ptr nonnull @qk_seg0_s3_q3, ptr nonnull @g_seg0_s3_q3)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @fused_softmax(ptr nonnull @g_seg0_s3_q3, ptr nonnull @up_seg0_s3_q3, ptr nonnull @s_seg0_s3_q3, ptr nonnull @r_seg0_s3_q3)
  tail call void @mul_r_gp(ptr nonnull @r_seg0_s3_q3, ptr nonnull @gp_seg0_s3_q3)
  tail call void @matmul_g_b_bf16(ptr nonnull @g_seg0_s3_q3, ptr nonnull @v_seg0_s3_q3, ptr nonnull @gp_seg0_s3_q3)
  tail call void @accum_sp_r_s(ptr nonnull @sp_seg0_s3_q3, ptr nonnull @r_seg0_s3_q3, ptr nonnull @s_seg0_s3_q3)
  tail call void @vector_copy_32elems_pythoc(i32 0, ptr nonnull @s_seg0_s3_q3, ptr nonnull @sp_seg0_s3_q3)
...
.preheader6:                                      ; preds = %.preheader6.preheader, %.preheader6
  ...
  %4 = getelementptr bfloat, ptr @gp_seg0_s3_q3, i20 %3
...
.preheader5:                                      ; preds = %.preheader6, %.preheader5
  ...
  %10 = getelementptr bfloat, ptr @up_seg0_s3_q3, i20 %9
...
.preheader:                                       ; preds = %.preheader5, %.preheader
  ...
  %16 = getelementptr bfloat, ptr @sp_seg0_s3_q3, i20 %15
